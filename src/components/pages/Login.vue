<template>
  ...
  <button class="btn btn-lg btn-primary btn-block" type="submit">管理者登入</button>
            <router-link to="/user/login">
           <button class="btn btn-accent btn-block rounded-0 btn-lg py-3 text-primary mt-2">切換到使用者</button>
          </router-link>
